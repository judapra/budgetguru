...
export function CategoryForm({ userId, category }: CategoryFormProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      if (isEditing) {
        const categoryDoc = doc(firestore, `users/${userId}/company_categories/${category.id}`);
        ...
        const categoriesCollection = collection(firestore, `users/${userId}/company_categories`);
