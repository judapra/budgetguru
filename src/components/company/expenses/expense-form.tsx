    ...
    try {
        if (isEditing && expense) {
            ...
            for (let i = 0; i < totalInstallments; i++) {
                ...
                const expenseRef = doc(collection(firestore, `users/${userId}/company_expenses`));
            ...
            const expenseData = {
                ...
                userId,
                installments: values.isRecurring && values.installments ? `1/${values.installments}` : undefined
            };
        ...
        const permissionError = new FirestorePermissionError({
            path: isEditing ? `users/${userId}/company_expenses/${expense!.id}` : `users/${userId}/company_expenses`,
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Compra de material, Marketing" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
