...
// A prop 'className' é a chave para controlar o tamanho e a cor
export function Logo({ className }: { className?: string }) {
  return (
    <svg
      className={className} // A classe é aplicada aqui
      viewBox="0 0 178 141" // O viewBox original foi mantido para preservar a proporção
      fill="none"
    ...
    >
      <path
        ...
        fill="currentColor" // A mágica acontece aqui
      />
      <path
