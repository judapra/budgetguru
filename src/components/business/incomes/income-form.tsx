...
export function IncomeForm({ categories, userId, income, children }: IncomeFormProps) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
        if (isEditing) {
            const incomeDoc = doc(firestore, `users/${userId}/business_incomes/${income.id}`);
            ...
            const incomesCollection = collection(firestore, `users/${userId}/business_incomes`);
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Venda Projeto X, Consultoria" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
